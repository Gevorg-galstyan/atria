...
@section('content')
    ...
    <section class="section paralbackground page-banner hidden-xs"
             style="background-image:url({{asset('upload/page_banner.jpg')}});" data-img-width="2000"
             data-img-height="400" data-diff="100">
    </section><!-- end section -->
        ...
        <div class="container">
            <div class="notfound">
                ...
                <p>
                    ...
                    <a href="{{route('home')}}">Home </a> or search something from search form.
                </p>
            </div>
        </div><!-- end container -->
    </section><!-- end section -->
